...
import { useDeleteLeaveById } from "../../hooks";
...
const Leave = ({ leaveId, startDate, endDate, employeeId, description, status, employeeName }) => {
  ...
  const handleDelete = () => {
    deleteLeaveById( { employeeId, leaveId },  {
      onSuccess: () => {
